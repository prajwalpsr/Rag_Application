...
def get_inngest_client() -> inngest.Inngest:
    return inngest.Inngest(app_id="rag_application", is_production=False)
...
st.divider()
st.title("Manage Uploaded PDF's")

uploads_dir = Path("uploads")
if uploads_dir.exists():
    pdf_files = [f for f in uploads_dir.iterdir() if f.suffix == ".pdf"]
else:
    pdf_files = []
